...
<HTML>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<asp:datagrid id="dgSC" style="Z-INDEX: 101; LEFT: 417px; POSITION: absolute; TOP: 323px" runat="server"
			...
			</asp:datagrid><asp:label id="lbCId" style="Z-INDEX: 102; LEFT: 420px; POSITION: absolute; TOP: 277px" runat="server"
