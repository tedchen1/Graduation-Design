...
<HTML>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<FONT face="宋体">
				<asp:label id="Label1" style="Z-INDEX: 106; LEFT: 381px; POSITION: absolute; TOP: 390px" runat="server">课程名称</asp:label>
				...
				<asp:label id="Label4" style="Z-INDEX: 107; LEFT: 381px; POSITION: absolute; TOP: 351px" runat="server">课程编号</asp:label>
				<asp:label id="Label2" style="Z-INDEX: 100; LEFT: 381px; POSITION: absolute; TOP: 430px" runat="server">课程类别</asp:label>
				<asp:label id="Label8" style="Z-INDEX: 104; LEFT: 421px; POSITION: absolute; TOP: 464px" runat="server">学分</asp:label>
				<asp:label id="Label7" style="Z-INDEX: 103; LEFT: 381px; POSITION: absolute; TOP: 505px" runat="server">前导课程</asp:label>
				<asp:label id="Label3" style="Z-INDEX: 101; LEFT: 381px; POSITION: absolute; TOP: 543px" runat="server">最大人数</asp:label>
				<asp:label id="Label6" style="Z-INDEX: 102; LEFT: 383px; POSITION: absolute; TOP: 642px" runat="server">课程介绍</asp:label>
